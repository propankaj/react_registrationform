...
class RegistrationForm extends Component {
   /*   this.props.text  =>  single component used in many different places in your app with
    slightly different properties by referring to 'this.props' in your render function.*/
  constructor(props){
    super(props); 
   this.state = {
      firstName: '',
      ...
      /* validation valid:*/
      valid: {
        firstName: true,/*means a field is invalid.*/
        lastName: true,
        username: true,
        password: true,
        email: true,
      },
      /*denote that the user has touched the form input*/
      touched: {
        firstName: false,
        lastName: false,
        username: false,
